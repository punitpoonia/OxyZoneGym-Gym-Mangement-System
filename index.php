		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 m-auto text-white">
					<h2>Home</h2>
					<p>At our gym, we're more than just a place to work out; we're a community dedicated to transforming lives. We believe that every drop of sweat brings you closer to your goals, and we're here to inspire and support you on your journey to a healthier, stronger, and more confident you. Join us today and experience the difference of a gym that's committed to your success."</p>
				</div>
			</div>
		</div>
	</section>
